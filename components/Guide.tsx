...
const Guide = () => {
  return (
    <section className='flexCenter flex-col border-2 '>
      <div className='padding-container max-container w-full pb-24'>
        <Image src='/camp.svg' alt='svg' width={50} height={50} />
      ...
      <div className='flexCenter max-container relative w-full '>
        <Image src='/boat.png' alt='boat' width={1440} height={580} 
               className='w-full  rounded-2xl object-cover object-center 2xl:rounded-5xl'  />
        <div className='flex absolute  bg-white py-8 pl-5 pr-7 gap-3 rounded-3xl border shadow-md md:left-[5px] lg:top-20 '>
          <Image src='/meter.svg' alt='meter' width={16} height={158} className='h-full w-auto'  />
          <div className='flexBetween flex-col '>
            <div className='flex w-full flex-col'>
              <div className='flexBetween w-full'>
                <p className='regular-16 text-gray-20'>Destination</p>
                <p className='bold-20 text-green-50'>48min</p>
              </div>
